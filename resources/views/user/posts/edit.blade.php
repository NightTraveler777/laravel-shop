...
@section('content')
    <div class="tab-content dashboard_content" data-aos="fade-up" data-aos-delay="200">
        <div class="tab-pane fade show active" id="dashboard">
            <h4>{{ $post->title }}</h4>
            <form role="form" method="post" action="{{ route('user.post.update', ['post' => $post->id]) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror"
                              ...
                              rows="3" placeholder="Цитата...">{{ $post->description }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('content') is-invalid @enderror"
                              ...
                              rows="7" placeholder="Контент...">{{ $post->content }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div><img class="img-thumbnail mt-2" src="{{ $post->getImage() }}" alt="" width="200"></div>
                </div>
