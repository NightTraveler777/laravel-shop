...
@section('content')
    ...
    <div class="blog-single-tags-share d-md-flex justify-content-between">
        ...
        <div class="blog-single-share mb-xs-15px d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
            ...
            @endperm
            @perm('edit-post')
                <a class="btn btn-primary btn-sm blog-btn" href="{{ route('posts.edit', ['post' => $post->id]) }}">
            ...
            <div class="nav-left d-flex justify-content-start align-items-center">
                @isset($previous_post)
                    ...
                    <div class="media-side">
                        ...
                        <h5><a href="{{ route('posts.single', ['slug' => $previous_post->slug]) }}">{{ $previous_post->title }}</a>
                        </h5>
                    </div>
                @endisset
            </div>
            <div class="nav-right d-flex justify-content-end flex-row-reverse align-items-center">
                @isset($next_post)
                    ...
                    <div class="media-side">
                        ...
                        <h5><a href="{{ route('posts.single', ['slug' => $next_post->slug]) }}">{{ $next_post->title }}</a>
                        </h5>
                    </div>
                @endisset
            </div>
    ...
    @isset($comments)
        @include('admin.posts.comments', ['comments' => $comments])
    @endisset
@endsection
